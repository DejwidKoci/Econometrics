...
if k > 1:
    print('produkcja wzrasta szybciej niż czynniki produkcji, mamy do czynienia z tzw. rosnącymi efektami skali produkcji')
elif k < 1:
    print('produkcja wzrasta wolniej niż czynników produkcji, mamy do czynienia z tzw. malejącymi efektami skali produkcji')
else:
    print("Występują stałe efekty skali produkcji")
