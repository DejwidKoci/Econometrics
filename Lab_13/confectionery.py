...
print(f"Krańcowa wydajność kapitału wynosi: {round(PKK, 2)}, czyli o {round(PKK, 2)} jednostek przeciętnie wzrośnie wielkość produkcji jeśli nakład kapitału zwiększy się o jednostkę przy nizemienionych nakładach pozostałych czynników produkcji ")
