...
print()
print("INTERPRETACJE: ")
print(f"Wzrost miesięcznych dochodów o 1% powoduje wzrost miesięcznego spożycia owoców suszonych o {round(model_01.params['X_real'], 2)}% ")
...
plt.scatter(data['X_real'], data['suszone'], label = 'Y', marker = 'o')
plt.xlabel('X')
plt.ylabel('Y')
...
print()
print("INTERPRETACJE: ")
print(f"Wraz ze wzrostem dochodów zwiększało się spożycie owoców suszonych ale nie przekraczały one {round(saturation, 2)}%")
print(f"Na początku wraz ze wzrostem dochodów zwiększało się spożycie owoców suszonych w przyspieszonym tempie po czym po przekroczeniu dochodów na poziomie {round(vertex, 2)} spożycie owoców zaczeły wzrastać wolniej")
...
print()
print("INTERPRETACJE: ")
print(f"Wraz ze wzrostem dochodów zwiększało się spożycie owoców suszonych ale nie przekraczały {round(a, 2)}%")
