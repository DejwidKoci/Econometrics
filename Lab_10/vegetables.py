...
print(f"Na początku wraz ze wzrostem dochodów zwiększały się wydatki na warzywa w przyspieszonym tempie po czym po przekroczeniu dochodów na poziomie {round(vertex, 2)} wydatki na warzywa zaczeły wzrastać wolniej")
...
print()
print("INTERPRETACJE: ")
print(f"Wraz ze wzrostem dochodów zwiększały się wydatki na warzywa ale nie przekraczały {round(a, 2)}%")
